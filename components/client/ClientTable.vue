      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 mb-6">
        <div class="p-4 border-b border-gray-200 dark:border-gray-700">
          <div class="flex flex-wrap items-center gap-4">
            ...
            <!-- Filter Email -->
            <select v-model="filters.email" class="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
            ...
            <select v-model="filters.deleted" class="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
              <option value="">Filter Deleted</option>
            ...
            <tr v-for="user in filteredData" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
              ...
              <td class="py-4 px-6 text-right">
                <div class="flex items-center justify-end gap-2">
                  ...
                  />
                  <!-- Edit -->
                 <Nuxt-link :to="`clients/${user.id}/edit`" >
                   <UButton
                       icon="i-lucide-edit"
                       variant="ghost"
                       size="sm"
